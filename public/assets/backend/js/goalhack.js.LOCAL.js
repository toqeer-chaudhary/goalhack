...
function showStrategyLineChart()
{
    $('#vision_pie_dash_chart').hide();
    $('#vision_line_chart').hide();
    $('#vision_bar_dash_chart').hide();
    $('#strategy_line_chart').show();
    $('#strategy_pie_dash_chart').hide();
    $('#strategy_bar_dash_chart').hide();
    $('#kpi_line_chart').hide();
    $('#kpi_pie_dash_chart').hide();
...
function showStrategyPieChart()
{
    $('#vision_pie_dash_chart').hide();
    $('#vision_line_chart').hide();
    $('#vision_bar_dash_chart').hide();
    $('#strategy_line_chart').hide();
    $('#strategy_pie_dash_chart').show();
    $('#strategy_bar_dash_chart').hide();
    $('#kpi_line_chart').hide();
    $('#kpi_pie_dash_chart').hide();
    $('#kpi_bar_dash_chart').hide();
    ...
    $.ajax({
        ...
        success:function (response) {
            ...
            function strategyLineDrawChart() {
                ...
                var chart = new google.visualization.LineChart(document.getElementById('strategy_curve_chart'));
            ...
            function strategyPieDrawChart() {
                ...
                var chartPie = new google.visualization.PieChart(document.getElementById('strategy_pie_chart'));
                chartPie.draw(data, optionsPie);
            ...
            function strategyBarDrawChart() {
                ...
                {
                    data.addRows([
                        [d_kpis[d_kpis_length].name , d_kpis_per[d_kpis_length]],
                    ]);
                }
                ...
                var barChart = new google.visualization.ColumnChart(document.getElementById('strategy_bar_chart'));
                barChart.draw(data, barOptions);
                //$('#strategy_bar_dash_chart').show();
...
function showKpiPieChart()
{
    ...
    $('#strategy_bar_dash_chart').hide();
    $('#kpi_line_chart').hide();
    $('#kpi_pie_dash_chart').show();
    $('#kpi_bar_dash_chart').hide();
    $('#goal_line_chart').hide();
    $('#goal_pie_dash_chart').hide();
    $('#goal_bar_dash_chart').hide();
}
function showKpiBarChart()
{
    $('#vision_pie_dash_chart').hide();
    $('#vision_line_chart').hide();
    $('#vision_bar_dash_chart').hide();
