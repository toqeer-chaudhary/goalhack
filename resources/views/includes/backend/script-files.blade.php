...
{{--sweet alert--}}
<script src="{{asset("assets/backend/js/custom/sweetalert.min.js")}}"></script>

{{--converting the code into a javascript file and the type attribute's value is come with the template--}}
{{--<script type="application/javascript" src="{{asset("assets/backend/js/application.js")}}"></script>--}}
...
{{--goal hack js--}}
<script src="{{asset("assets/backend/js/goalhack.js")}}"></script>
...
<script src="{{asset("assets/backend/plugins/telephone/js/intlTelInput.js")}}"></script>
<script src="{{asset("assets/backend/plugins/telephone/js/utils.js")}}"></script>

<script src="{{asset("assets/backend/js/moment.js")}}"></script>

{{--Pick Me Up Calender--}}
<script src="{{asset("assets/backend/js/pickmeup.min.js")}}"></script>
<script src="{{asset("assets/backend/js/jquery.pickmeup.uikit.js")}}"></script>
