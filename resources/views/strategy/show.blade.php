...
@section("page-header")
    <div class="ks-title">
       <h3 class="text-primary">{{$strategyData->name}} Details</h3>
    </div>
@endsection
            ...
            <div class="ks-wrapper">
               ...
               <span class="ks-name">
                  {{$strategyData->name}}
                        ...
                        &nbsp;
                        <div class="">
                            <span class="ks-icon la la-map-marker ks-color-success">Start Date</span> {{$strategyData->start_date}}
                    ...
                    <div class="ks-project">
                        Created At
                        <span class="ks-target ks-color-info">&nbsp;{{$strategyData->created_at}}</span>
                        &nbsp;
                        Created By
                        <span class="ks-target ks-color-success">&nbsp;{{\App\Models\User::find($strategyData->user_id)->name}}</span>
                    </div>
                ...
                <div class="card panel ks-attach-files-widget">
                    <h5 class="card-header">{{$strategyData->kpis->count()}} KPIs agaisnt {{$strategyData->name}} are as follows</h5>
                    <div class="card-block">
                        @foreach($strategyData->kpis as $kpi)
                        <ul class="ks-uploaded-files">
                            <li>
                                <span class="ks-icon la la-bar-chart ks-color-primary"></span>
                                <div class="ks-body">
                                    <div class="ks-header">
                                        <span class="ks-filename">{{$kpi->name}}</span>
                                    </div>
                                ...
                                <table class="ks-table-details">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="ks-body">
                                                {{$strategyData->vision->start_date->toFormattedDateString() . "    ,    " . $strategyData->vision->end_date->toFormattedDateString()}}
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div class="ks-body">
                                                <p class="ks-user">
                                                    <ul>
                                                        @forelse($strategyData->users as $user)
                                                             <li>
